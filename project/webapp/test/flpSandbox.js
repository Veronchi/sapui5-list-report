		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Products App",
									"targetURL": "#veronchileverxproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"veronchileverxproject-display": {
								"semanticObject": "veronchileverxproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=veronchi.leverx.project",
									"url": sap.ui.require.toUrl("veronchi/leverx/project")
								}
							}
						}
					}
